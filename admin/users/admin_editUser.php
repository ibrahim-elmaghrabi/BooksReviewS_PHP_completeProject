...
if(isset($_GET['user_id'])){
 ...
 if(isset($_POST['updateUser'])){
    ...
    if(!(isset($_POST['email']) && filter_input(INPUT_POST, 'email' , FILTER_VALIDATE_EMAIL))){
     ...
     if($existEmail){
        if($_POST['updateUser'] && $existEmail['id'] != $_POST['id']){
    ...
    if(!$error_fields){
        ...
        $user_id           = $_POST['id'] ;
          unset($_POST['updateUser'] , $_POST['passwordConf'] , $_POST['id']) ;
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <div>
                        ...
                        <input type="text" name="username"value="<?= (isset($username)) ? $username : ''?>"class="text-input">
                        <div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email"value="<?= (isset($email)) ? $email : ''?>"  class="text-input">
                        <div>
                    ...
                    <div>
                     ...
                     <div>
                        <label>
                            <input type="checkbox" name="admin" <?= (isset($admin) ) ? "checked": 0 ?> />
                            Admin
                        </label>
